...
train_path = '/content/drive/MyDrive/AICUP-G/Random1200'
val_path = '/content/drive/MyDrive/AICUP-G/Test_data/Val150'
print('Training Data loading...')
train_images, train_labels = get_images(train_path)
print('Validation Data loading...')
val_images, val_labels = get_images(val_path)
...
print("Shpae of Images:",val_images.shape)
print("Shape of Labels:",val_labels.shape)

plot_img(train_images, train_labels)

net = EfficientNetV2M(include_top = False, weights = 'imagenet', input_tensor = None,
...
modelpath = '/content/drive/MyDrive/AICUP-G/model/EFF0510.h5'
...
model.load_weights('/content/drive/MyDrive/AICUP-G/model/EFF0505.h5')
#data_argumatation
...
train_history = model.fit(datagen.flow(train_images, train_labels,batch_size = BS), 
                                    epochs = n_epochs, steps_per_epoch = len(train_images) // BS,
