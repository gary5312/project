...
# train_history = model.fit(x = train_images, y = train_labels, validation_split = 0.2, epochs = n_epochs, batch_size = 128)

model_dir = '/content/drive/MyDrive/AICUP-G/model/'
dat = datetime.now()
name = model_dir + str(dat) + '.h5'
model.save(name)
