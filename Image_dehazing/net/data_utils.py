...
pwd=os.getcwd()
print(pwd)
path='/content/drive/MyDrive/colab_space/FFA-Net-master-original/net/data'#path to your 'data' folder

ITS_train_loader=DataLoader(dataset=RESIDE_Dataset(path+'/val',train=True,size=crop_size),batch_size=BS,shuffle=True)
